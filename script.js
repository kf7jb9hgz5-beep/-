...
function updateCanvas() {
    ...
    const contentContainer = document.getElementById("canvasContentContainer");

    if (infoContainer && contentContainer) {
        if (infoContainer.parentNode !== contentContainer) contentContainer.appendChild(infoContainer);
